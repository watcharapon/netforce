...
var MultiView=React.createClass({
    ...
    render() {
        if (this.state.mode=="list") {
            return <List title={this.props.title} model={this.props.model} layout={this.props.list_layout} tabs={this.props.tabs} on_new={this.on_new} on_select={this.on_select}/>
